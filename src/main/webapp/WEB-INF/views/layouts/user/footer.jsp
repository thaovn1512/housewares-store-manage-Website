...
<!-- Footer Section Begin -->
			...
			<div class="row">
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="footer__about">
						...
						<ul>
							<li>Address: 97 Man Thiện, phường Hiệp Phú, Thành phố Hồ Chí Minh</li>
							<li>Phone: 0397181350</li>
							<li>Email: n18dccn209@student.ptithcm.edu.vn</li>
						</ul>
					</div>
				</div>
	...
	<script src="resources/user/js/mixitup.min.js"></script>
	<script src="resources/user/js/owl.carousel.min.js"></script>
	<script src="resources/user/js/main.js"></script>
	<script src="resources/user/js/btnClick.js"></script>
